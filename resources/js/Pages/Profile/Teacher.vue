<template>
    <div class="w-full bg-white rounded-lg border border-gray-200 p-4 dark:bg-gray-800 dark:border-gray-700">
        <div class="mb-3">
            ...
            <a-select :class="$page.props.errors.department ? 'border-custom ' : ''" class="width-100" size="large"
                v-model:value="form.department" show-search :placeholder="__('Select Department')" :options="options"

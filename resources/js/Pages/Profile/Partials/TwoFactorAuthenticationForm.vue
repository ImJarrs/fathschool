...
<template>
    <JetActionSection>
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg dark:text-gray-400 font-medium text-gray-900">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg dark:text-gray-400 font-medium text-gray-900">
            ...
            <div v-if="twoFactorEnabled">
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 rounded-lg dark:text-gray-400">

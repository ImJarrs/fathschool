    ...
    <AppLayout :title="__('Dashboard')">
        ...
        <div class="pb-12">
            ...
            >
                ...
                <stat-card
                    :title="`${__('Total Leave Requests')}`"
                    :route="route('leave.requests')"
                    :value="total_leave_requests"
                    :label="__('Requests')"
                />
                <stat-card
                    :title="`${__('Exams (Current Month)')}`"
                    :route="route('exam.index')"
                    :value="this_month_total_exams"
                    :label="__('Exams')"
                />
                <stat-card
                    :title="`${__('Events (Current Week)')}`"
                    :route="route('event.index')"
                    :value="this_week_events"
                    :label="__('Programs')"
                />
            </div>
            <div id="welcome"></div>
            <div
                class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-[25px]"
            >
                <div class="card bg-white dark:bg-gray-800 rounded-lg">
                    <div class="card-top px-6">
                        <div class="flex justify-between items-center">
                            ...
                            <div
                                class="py-4 flex gap-6 items-center lg:flex-row flex-col"
                            >
                                <ul class="flex mb-0">
                                    <li
                                        class="pl-6 cursor-pointer"
                                        :class="
                                            incomeGraphTab == 'today'
                                                ? 'text-blue-500'
                                                : 'text-black/[0.45] dark:text-gray-400'
                                        "
                    ...
                    <div class="card-bottom p-6 flex flex-wrap gap-4">
                        <BarChart
                            :labels="paid_data_label_income"
                            :data="paid_data_value_income"
                            id="student_paid_chart"
                        />
                    </div>
                </div>
                <div class="card bg-white dark:bg-gray-800 rounded-lg">
                    ...
                    <div class="card-bottom p-6">
                        <BarChart
                            :labels="admission_data_label_income"
                            :data="admission_data_value_income"
                    ...
                    <div class="card-bottom">
                        <global-table>
                            ...
                            <template #body>
                                ...
                                >
                                    <template
                                        v-for="birthday_user in upcoming_birthdays"
                                        :key="birthday_user.id"
                                    >
                                        <tr
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    :class="
                                                        event.status == 'Ended'
                                                            ? 'bg-red-100 text-red-800 dark:bg-red-500 dark:opacity-60 dark:text-red-100'
                                                            : 'bg-blue-100 text-blue-800 dark:bg-gray-700 dark:text-gray-400'
                                                    "
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-lg xl:col-span-2 xl:row-span-3"
            >
                <div class="flex justify-between items-center">
                    <h2
                    ...
                    <Link
                        ...
                        class="text-blue-500 px-6 py-4 text-base mb-0 dark:text-gray-400"
                    >
                        {{ __("Class Schedule") }}
                    </Link>
                </div>
...
export default {
    ...
    data() {
        return {
            activeTab: "day",
            incomeGraphTab: this.query.query
                ? this.query.query
                : this.query.start_date ?? "week",
            admissionGraphTab: this.query.admissionQuery
                ? this.query.admissionQuery
                : "week",

<template>
    <AppLayout :title="__('Edit Invoice')">
        <Breadcrumb>
            <BreadcrumbLink :href="route('invoice.index')" title="Recurring Invoice"/>
            <BreadcrumbLink :title="__('Edit Invoice')"/>
        </Breadcrumb>

        <div class="pb-12">
            <page-header>
                {{ __('Edit Recurring Invoice') }}
                <template #content>
                    ...
                    <div class="col-span-2">
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="w-full p-6 dark:border-gray-700">
                                    ...
                                    <div class="mb-4">
                                        <div class="flex justify-end items-end">
                                            <button type="button" v-if="i != 0" @click="removeItem(item, i)"
                                                class="bg-red-500 hover:bg-red-500 rounded-full p-1">
                                ...
                                <div class="mt-2">
                                    <div @click="addNew()" class="cursor-pointer text-lg font-bold text-blue-500">
                                        + {{ __('Add Item') }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white mt-2 dark:bg-gray-800 rounded-lg">
                            <div class="w-full p-6 dark:border-gray-700">
                                <div class="mt-4">
                                    <global-label for="document" value="Attachments" :required="false" />
                                ...
                                <div class="mt-4">
                                    <global-label for="message" value="Message To Recipient" :required="false" />
                    ...
                    <div class="col-span-1">
                        <div class="bg-white dark:bg-gray-800 rounded-lg mb-2">
                            <div class="px-4 py-2 dark:border-gray-700">
                                <global-label for="recipient" :value="__('Invoice Type')" class="ml-1 mt-3 mb-1"
                                    :required="true" />
                                <div
                            ...
                            <div class="px-4 py-0 dark:border-gray-700">
                                <global-label for="currency" value="Select Currency" class="ml-1 mb-1"
                                    :required="true" />
                                <div class="w-full">
                            ...
                            <div class="w-full px-4 py-2 dark:border-gray-700">
                                <global-label for="recipient" value="Select Recipient" class="ml-1 mb-1"
                                    :required="true" />
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="w-full p-6 dark:border-gray-700">
                                <div class="mb-3">
                                    <global-label for="invoice_title" value="Invoice Title" :required="true" />
                                ...
                                <div class="mb-3">
                                    <global-label for="invoice_number" value="Invoice No" :required="true" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="paid"
                                        ...
                                        <input type="checkbox" value="paid" v-model="form.status" id="paid" name=""
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="mb-3">
                                        <global-label for="invoice_date" value="Invoice Date" :required="true" />
                                        <a-date-picker
...
export default {
    ...
    data() {
        return {
            ...
            transaction_items: [],
            visible: false,
            selected_user_image: this.invoice.user.profile_photo_url,
            date_value: dayjs(this.invoice.date),
            due_date_value: dayjs(this.invoice.due_date),
            form: {
                user: this.invoice.user.id,
                date: this.invoice.date,
                due_date: this.invoice.due_date,
                due_date_in: this.invoice.due_date_in,
                amount: this.amounts,
                ...
                attachments: [],
                total_amount: 0,
                status: this.invoice.status == 'paid' ? true : false,
                // about recurring
                recurring: this.invoice.recurring,
                recurring_days: this.invoice.recurring_days,
                _method: 'PUT'
            },
            dueDate: [
    ...
    mounted() {
        for (let index = 0; index < this.invoice.items.length; index++) {
            const element = this.invoice.items[index];
    ...
    methods: {
        submit() {
            this.loading = true;
            this.$inertia.post(
                this.route("invoice.update", this.invoice.id), this.form,
                {
                    preserveScroll: true,

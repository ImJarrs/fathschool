                            ...
                            >
                                ...
                                <div class="mb-3">
                                    ...
                                    <div
                                        ...
                                        v-if="
                                            administration &&
                                            administration.documents.length > 0
                                        "
                                    >
                                        <div
                                            class="relative mt-2"
...
export default {
    ...
    data() {
        return {
            wizard: 1,
            date_of_birth_value: this.administration
                ? this.administration.date_of_birth
                    ? dayjs(this.administration.date_of_birth)
                    : null
                : null,
            passing_year_value: this.administration
                ? this.administration.profile
                    ? dayjs(this.administration.profile.passing_year)
                    : null
                : null,
            validate_errors: {},
            document_size: [1],
            form: useForm({
                nik: this.administration ? this.administration.nik : "",
                rfid: this.administration ? this.administration.rfid : "",
                ...
                department: this.administration
                    ? this.administration.department_id
                    : "",
                ...
                highest_degree_name: this.administration
                    ? this.administration.profile
                        ? this.administration.profile.highest_degree_name
                        : null
                    : null,
                institute_name: this.administration
                    ? this.administration.profile
                        ? this.administration.profile.institute_name
                        : null
                    : null,
                passing_year: this.administration
                    ? this.administration.profile
                        ? this.administration.profile.passing_year
                        : null
                    : null,
                religion: this.administration
                    ? this.administration.profile
                        ? this.administration.profile.religion
                        : null
                    : null,
                nationality: this.administration
                    ? this.administration.profile
                        ? this.administration.profile.nationality
                        : null
                    : null,

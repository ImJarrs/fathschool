<template>
    <AppLayout :title="__('Sms Template')">
        <Breadcrumb>
            <BreadcrumbLink title="Sms Template"/>
        </Breadcrumb>
        ...
        <div class="pb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto">
                <div class="md:col-span-2">
                    <table-content @edit="edit" :templates="templates" />
                ...
                <div class="md:col-span-1">
                    <div
                        ...
                        <update-form :template="template" v-if="update" />
                    </div>
                </div>
            </div>
        </div>
...
import TableContent from "@/Shared/Admin/Sms/Table.vue";
import CreateForm from "@/Shared/Admin/Sms/CreateForm.vue";
import UpdateForm from "@/Shared/Admin/Sms/UpdateForm.vue";

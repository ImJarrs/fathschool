<template>
    <AppLayout :title="__('Teacher Create')">
        <Breadcrumb>
            <BreadcrumbLink :title="__('Teacher Create')" />
        </Breadcrumb>
        ...
        <div class="mx-auto pb-12">
            ...
            <div class="w-full lg:w-1/2 mx-auto">
                <div class="flex items-center">
                    <div
                        :class="wizard > 1 ? 'text-blue-600 ' : 'text-gray-500'"
                        class="flex items-center relative"
                    >
                        <div
                            :class="
                                wizard > 1 ? 'border-blue-600' : 'border-white'
                            "
                    ...
                    <div
                        :class="wizard > 1 ? 'border-blue-600' : 'border-white'"
                        class="flex-auto border-t-4 transition duration-500 ease-in-out"
                    ></div>
                    <div
                        :class="wizard > 2 ? 'text-blue-600 ' : 'text-gray-500'"
                        class="flex items-center relative"
                    >
                        <div
                            :class="
                                wizard > 2 ? 'border-blue-600' : 'border-white'
                            "
                            class="rounded-full transition duration-500 ease-in-out h-11 w-11 py-2.5 border-2"
                        >
                            <CheckCircleIcon
                            ...
                            />
                            <div
                                class="absolute whitespace-nowrap -top-3 -ml-8 w-full text-center mt-16 text-xs font-bold"
                            >
                    ...
                    <div
                        :class="wizard > 2 ? 'border-blue-600' : 'border-white'"
                        class="flex-auto border-t-4 transition duration-500 ease-in-out"
                    ></div>
                    <div
                        :class="wizard > 2 ? 'text-blue-600 ' : 'text-gray-500'"
            ...
            <div class="w-full lg:w-1/2 mx-auto rounded-lg mt-12">
                ...
                >
                    <div
                        class="grid sm:grid-cols-1 md:grid-cols-1 sm:gap-1 md:gap-4"
                    >
                        <!-- Step 1 content -->
                            ...
                            >
                                <div class="mb-3">
                                    ...
                                    <global-input
                                        ...
                                        :placeholder="__('Enter NIK')"
                                        :error="validate_errors.nik"
                                    />
                                    <input-error :error="validate_errors.nik" />
                                </div>
                                <div
                        ...
                        <template v-if="wizard == 2">
                            ...
                            >
                                <div class="mb-3">
                                    <global-label
                                        for="highest_degree_name"
                                        value="Highest Degree Name"
                                        :required="true"
                                    />
                                    <global-input
                                        type="text"
                                        v-model="form.highest_degree_name"
                                        id="highest_degree_name"
                                        class="block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                                        :placeholder="__('Highest Degree Name')"
                                        :error="
                                            validate_errors.highest_degree_name
                                        "
                                    />
                                    <input-error
                                        :error="
                                ...
                                <div class="mb-3">
                                    ...
                                    <global-input
                                        ...
                                        :error="validate_errors.institute_name"
                                    />
                                    <input-error
                                        :error="validate_errors.institute_name"
                                    />
                                ...
                                <div class="mb-3">
                                    ...
                                    />
                                    <a-date-picker
                                        @change="getPassingYear"
                                        placeholder="Passing Year"
                                        class="ant-datepicker-custom"
                                        :format="getDateTimeFormat()"
                                        v-model:value="passing_year_value"
                                        picker="year"
                                    />
                                    <input-error
                                        :error="validate_errors.passing_year"
                                    />
                                </div>
                            </div>
                            ...
                            >
                                <div class="mb-3">
                                    ...
                                    />
                                    <input-error
                                        :error="validate_errors.department"
                                    />
                                </div>
                                <div class="mb-3">
                                    <global-label
                                    ...
                                    <global-input
                                        ...
                                        :error="validate_errors.religion"
                                    />
                                    <input-error
                                        :error="validate_errors.religion"
                                    />
                                ...
                                <div class="mb-3">
                                    ...
                                    />
                                    <input-error
                                        :error="validate_errors.nationality"
                                    />
                                </div>
                                <div class="mb-3">
                                    <global-label
                                    ...
                                    />
                                    <div
                                        v-for="(item, index) in document_size"
                                        :key="index"
                                    ...
                                    >
                                        <div class="w-full">
                                            <global-input
                                                type="text"
                                                v-model="
                                                    form.document_titles[index]
                                                "
                                                :id="'title' + index"
                                                class="block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                                                placeholder="Document Title"
                                                :error="validate_errors.note"
                                            />
                                        </div>
                                        <div class="w-full">
                                            <input
                                    ...
                                    >
                                        <div
                                            ...
                                            v-for="(
                                                doc, index
                                            ) in teacher.documents"
                                            :key="doc.id"
                                        >
                                            <a
                                                :href="doc.file_url_format"
                                                download
                                            >
                                            ...
                                            >
                                                <trash-icon
                                                    class="w-6 h-6 text-white p-0.5"
                                                />
                                            </button>
                                        </div>
                                    </div>
                                    <input-error
                                        :error="validate_errors.documents"
                                    />
                                </div>
                            </div>
                        </template>
                    ...
                    <template v-if="wizard == 3">
                        ...
                        >
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                ...
                                >
                                    <div
                                        class="font-bold capitalize text-base dark:text-gray-400"
                                    >
                                        {{ course.name }}
                                    </div>
                                ...
                                <input-error
                                    :error="validate_errors.subjects"
                                />
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <global-button
                            @click="wizardChange('next')"
                            v-if="wizard < 3"
                            :loading="false"
                            type="button"
                            cssClass="w-1/4 mt-3 py-1 font-bold"
                            theme="primary"
                        >
                            {{ __("Next") }}
                        </global-button>
...
export default {
    ...
    data() {
        return {
            wizard: 1,
            date_of_birth_value: this.teacher
                ? this.teacher.date_of_birth
                    ? dayjs(this.teacher.date_of_birth)
                    : null
                : null,
            passing_year_value: this.teacher
                ? this.teacher.profile
                    ? dayjs(this.teacher.profile.passing_year)
                    : null
                : null,
            validate_errors: {},
            document_size: [1],
            form: useForm({
                ...
                address: this.teacher ? this.teacher.address : "",
                gender: this.teacher ? this.teacher.gender : "",
                department: this.teacher ? this.teacher.department_id : "",
                date_of_birth: this.teacher ? this.teacher.date_of_birth : "",
                documents: [],
                document_titles: [],

                highest_degree_name: this.teacher
                    ? this.teacher.profile
                        ? this.teacher.profile.highest_degree_name
                        : null
                    : null,
                institute_name: this.teacher
                    ? this.teacher.profile
                        ? this.teacher.profile.institute_name
                        : null
                    : null,
                passing_year: this.teacher
                    ? this.teacher.profile
                        ? this.teacher.profile.passing_year
                        : null
                    : null,
                religion: this.teacher
                    ? this.teacher.profile
                        ? this.teacher.profile.religion
                        : null
                    : null,
                nationality: this.teacher
                    ? this.teacher.profile
                        ? this.teacher.profile.nationality
                        : null
                    : null,
                subjects: this.subjects ? this.subjects : [],
                _method: this.teacher ? "PUT" : "POST",
            }),
        };
    },
    watch: {
        ...
        passing_year_value: {
            ...
            handler(newVal, oldVal) {
                if (newVal) {
                    this.form.passing_year = dayjs(newVal).format("YYYY");
                } else {
    ...
    methods: {
        removeDoc(id) {
            if (confirm("Are your sure ??")) {
                this.$inertia.post(this.route("admin.doc.destroy", id), {
                    preserveScroll: true,
                });
            }
        },
        ...
        submit() {
            ...
            if (this.teacher) {
                this.form.post(this.route("users.update", this.teacher.id), {
                    preserveScroll: true,
                });
            } else {
        ...
        validationPart(wizard) {
            ...
            if (wizard == 1) {
                ...
                if (!this.form.highest_degree_name) {
                    Object.assign(this.validate_errors, {
                        highest_degree_name:
                            "The highest degree name field is required .",
                    });
                    hasError = true;
                }

<template>
    ...
    <Head :title="__('Teacher Class List')" />
    <AppLayout>
        <Breadcrumb>
            <BreadcrumbLink :title=" __('Teacher Subject List')" />
        </Breadcrumb>

        <div class="my-6">
            <page-header >
                <div class="dark:text-gray-400">{{ __('Teacher Subject') }}</div>
            </page-header>
            <div class="grid gap-6 md:grid-cols-6">
                <div class="grid gap-6 md:grid-cols-3 md:col-span-4 auto-rows-min">
                    <div class="p-6 dark:text-gray-400 bg-white dark:bg-gray-700 rounded-lg mb-2 md:col-span-3">
                        <div class="w-full">
                            <div class="my-2 flex items-center">
                                <div>
                                    <img class="w-24 h-24 object-cover rounded-lg" :src="teacher.profile_photo_url"
                                        alt="" />
                                </div>
                                <div class="ml-3">
                            ...
                            <h2 class="dark:text-gray-400" v-if="teacher.department">
                                {{ __('Department') }}: {{ teacher.department.name }}
                            </h2>
                    ...
                    <div class="md:col-span-3 md:flex gap-2">
                        <div
                            ...
                            <global-table class="py-0 bg-white mt-1">
                                ...
                                <template #body>
                                    <template v-if="teacher.documents.length > 0">
                                        <template v-for="document in teacher.documents" :key="document.id">
                                            <tr
                            ...
                            <div class="bg-white mt-1 p-4 rounded-lg">
                                ...
                                <div class="flex gap-2 items-center">
                                    ...
                                    <div>
                                        {{
                                        teacher.profile
                                        ? teacher.profile.institute_name
                                        : ""
                                        }}
                                    </div>
                                </div>
                    ...
                    <template v-if="teacher.subjects.length > 0">
                        <div class="card bg-white dark:bg-gray-700 rounded-lg dark:text-gray-400"
                            v-for="course in teacher.subjects" :key="course.id">
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                this.$inertia.post(
                    this.route("teacher.class.assign"),
                    this.form,
                    {
                        onSuccess: (page) => {

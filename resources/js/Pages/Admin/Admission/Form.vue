            ...
            <div class="w-full xl:w-1/2 mx-auto rounded-lg mt-12">
                ...
                >
                            ...
                            >
                                ...
                                <div class="mb-3">
                                    ...
                                    <global-input
                                        ...
                                        :placeholder="__('Enter NISN')"
                                        :error="errors_get.nisn"
                                    />
                                    <input-error :error="errors_get.nisn" />
                                </div>
                                ...
                                >
                                    <div class="mb-3">
                                        ...
                                        />
                                        <input-error
                                            :error="errors_get.date_of_birth"
                                        />
                                    </div>
                                    <div class="mb-3">
                                        <global-label
                        ...
                        <template v-if="wizard == 2">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <div
                                                                class="flex font-semibold dark:text-gray-400"
                                                            >
                                                                <div>
                                                                    {{
                                                                        __(
                            ...
                            >
                                <div class="mb-3">
                                    ...
                                    />
                                    <input-error
                                        :error="$page.props.errors.blood_group"
                                    />
                                </div>
                                <div class="mb-3">
                                    <global-label
                                        for="physical_disability"
                                ...
                                <div class="mb-3">
                                    <global-label
                                        for="previous_school_year_of_exist"
                                        value="Previous School Year Of Exist"
                                        :required="false"
                                    />
                                    <global-input
                                        id="previous_school_year_of_exist"
                                        v-model="
                                            form.previous_school_year_of_exist
                                        "
                                        type="text"
                                        class="block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                                        :placeholder="
                                ...
                                <div class="mb-3">
                                    ...
                                    <input-error
                                        :error="$page.props.errors.document"
                                    />
                                </div>
                                <div class="mb-1">
                                    <global-label
                    ...
                    <template v-if="wizard == 3">
                        ...
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 object-cover gap-4"
                        >
                            <label
                                :for="'course' + index"
                            ...
                            >
                                ...
                                >
                                    <h5
                                        class="text-2xl mb-0 font-medium text-gray-700 dark:text-gray-400"
                                    >
                                        {{ course.name }}
                                    </h5>
                                    <div class="">
                                        <input
                                            ...
                                            class="rounded-full border border-gray-400 p-2 w-6 h-6"
                                            type="checkbox"
                                            :id="'course' + index"
                                            name="courses"
                                        />
                        ...
                        <template v-if="courses_plans.length > 0">
                            ...
                            >
                                <label
                                    :for="'plan' + index"
                                    v-for="(plan, index) in courses_plans"
                                    :key="index"
                                    :class="
                                        form.plan == plan.id
                                            ? 'border-l-4 border-blue-500'
                                ...
                                >
                                    ...
                                    >
                                        <h5
                                            class="mb-0 text-2xl font-medium text-gray-700 dark:text-gray-400"
                                        >
                                            {{ plan.title }}
                                        </h5>
                                    ...
                                    <ul role="list" class="space-y-5 my-4">
                                        <li
                                            class="font-bold dark:text-gray-400"
                                        >
                                            {{ __("Benefits") }}
                                        </li>
                                        <li
                                ...
                                <input-error
                                    :error="$page.props.errors.course"
                                />
                            </div>
                        </template>
                    </template>
                    ...
                    <form @submit.prevent="storeParent()">
                        ...
                        >
                            ...
                            <div class="mb-3">
                                ...
                                <global-input
                                    type="email"
                                    v-model="createParent.email"
                                    id="email"
                                    name="email"
                                    class="mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                                    :placeholder="__('Enter Email')"
                                    :error="
                                        errors_get && errors_get.email
                                            ? errors_get.email[0]
                                            : ''
                                    "
                                />
                            ...
                            <div class="mb-3">
                                ...
                                <global-input
                                    type="password"
                                    v-model="createParent.password"
                                    id="password"
                                    class="mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                                    :placeholder="__('Password')"
                                    :error="
                                        errors_get && errors_get.password
                                            ? errors_get.password[0]
                                            : ''
                                    "
                                />
                                <input-error
                        ...
                        <global-button
                            :loading="createParent.processing"
                            type="submit"
...
export default {
    ...
    data() {
        return {
            wizard: 1,
            visible: false,
            date_of_birth_value: this.admission
                ? this.admission.date_of_birth
                    ? dayjs(this.admission.date_of_birth)
                    : null
                : null,
            errors_get: {},
            avatar_value: null,
            ...
            form: useForm({
                ...
                blood_group: this.admission
                    ? this.admission.profile.blood_group
                    : "",
                physical_disability: this.admission
                    ? this.admission.profile.physical_disability
                    : "",
                religion: this.admission ? this.admission.profile.religion : "",
                previous_school_name: this.admission
                    ? this.admission.profile.previous_school_name
                    : "",
                previous_school_year_of_exist: this.admission
                    ? this.admission.profile.previous_school_year_of_exist
                    : "",
                courses: this.user_courses ?? [],
                plan: this.admission ? this.admission.profile.plan_id : "",
                gender: this.admission ? this.admission.gender : "",
                date_of_birth: this.admission
                    ? this.admission.date_of_birth
                    : "",
                documents: [],
                document_titles: [],
    ...
    methods: {
        ...
        storeParent() {
            axios
                .post(this.route("parent.store"), this.createParent)
                .then((res) => {
                    this.createParent.nisn = "";
                    this.createParent.name = "";
                    this.createParent.email = "";
                    this.createParent.phone = "";
        ...
        fetchParent() {
            axios
                .post(this.route("admin.parent.index"))
                .then((res) => {
                    if (res.data.data) {

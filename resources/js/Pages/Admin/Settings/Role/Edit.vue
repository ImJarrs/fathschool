<template>
    <AppLayout :title="__('Role Edit')">
        <Breadcrumb>
            <BreadcrumbLink :title=" __('Settings')"/>
            <BreadcrumbLink :title=" __('Roles')"/>
            <BreadcrumbLink :title=" __('Role Edit')"/>
        </Breadcrumb>
        ...
        <div class="pb-12">
            <page-header>
                {{ __('Role Edit') }}
                <template #content>
                    <global-button :url="route('roles.index')" type="link" theme="primary">
                        {{ __('All Roles') }}
                    </global-button>
                </template>
            </page-header>
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        <div class="grid grid-cols-12 divide-y-0 divide-x  dark:divide-gray-600 gap-8">
                            <div class="col-span-12">
                                <form @submit.prevent="submit" class="rounded-b-lg dark:bg-gray-800">
                                    <div class="w-full sm:p-4 md:p-0 dark:bg-gray-700">
                                        <div class="lg:flex items-center justify-center w-full">
                                            <div
                                                class="focus:outline-none mt-6 lg:w-4/12 bg-white dark:bg-gray-700 px-6 rounded-lg">
                                        ...
                                        <div class="lg:flex items-center justify-center w-full mt-1">
                                            <div
                                                ...
                                                <div class="flex justify-between justify-items-center">
                                                    <global-label for="description" value="Description"
                                                        :required="false" />
                                                </div>
                                                <global-textarea type="text" v-model="form.description"

<template>
    <AppLayout :title="__('Language Create')">
        <Breadcrumb>
            <BreadcrumbLink :title=" __('Settings')" />
            <BreadcrumbLink :title=" __('Language')" />
            <BreadcrumbLink :title=" __('Language Create')" />
        </Breadcrumb>
        ...
        <div class="pb-12">
            <page-header>
                {{ __('Language Create') }}
                <template #content>
                    <global-button preserve-scroll :url="route('languages.index')" :loading="false" type="link"
                        theme="primary">
                        {{ __('All Language') }}
                    </global-button>
                </template>
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <a-select :class="$page.props.errors.name ? 'border-custom ' : ''"
                                                    size="large" class="width-100 testName" v-model:value="form.name" show-search
                                                    :placeholder="__('Select Language Name')" :options="options"
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <a-select :class="$page.props.errors.code ? 'border-custom ' : ''"
                                                    ...
                                                    :placeholder="__('Select Language Code')" :options="options2"
                                                    :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur">
                                                </a-select>

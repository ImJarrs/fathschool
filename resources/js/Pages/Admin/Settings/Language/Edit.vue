    ...
    <AppLayout :title="__('Language Edit')">
        ...
        <div class="pb-12">
            <page-header>
                {{ __('Language Edit') }}
                <template #content>
                    <global-button preserve-scroll :url="route('languages.index')" :loading="false" type="link" theme="primary">
                        {{ __('All Language') }}
                    </global-button>
                </template>
            </page-header>
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <a-select :class="$page.props.errors.name ? 'border-custom ' : ''"
                                                    size="large" class="width-100" v-model:value="form.name"
                                                    show-search :placeholder="__('Select Language Name')" :options="options"
                                                    :filter-option="filterOption" @focus="handleFocus"
                                                    @blur="handleBlur" @change="selectedCounty($event)">
                                                </a-select>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <a-select :class="$page.props.errors.code ? 'border-custom ' : ''"
                                                    size="large" class="width-100" v-model:value="form.code"
                                                    show-search :placeholder="__('Select Language Code')" :options="options2"
                                                    :filter-option="filterOption" @focus="handleFocus"
                                                    @blur="handleBlur">
                                                </a-select>
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div
                                                    ...
                                                    <input id="direction_ltr" type="radio" value="ltr"
                                                        v-model="form.direction" name="bordered-radio"
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    <label for="direction_ltr"
                                                ...
                                                <div
                                                    ...
                                                    <input id="direction_rtl" type="radio" value="rtl"
                                                        v-model="form.direction" name="bordered-radio"
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    <label for="direction_rtl"
                                                        class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">
                                                        {{ __('Right To Left') }}
                                                    </label>
                                                </div>

    ...
    <form @submit.prevent="submit()" class="p-6 dark:bg-gray-800 dark:text-gray-400">
        <div class="w-full">
            <div class="mb-3">
                ...
                class="width-100" v-model:value="form.course" show-search :placeholder="__('Select Course')"
                    :options="courses_options" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur"
                    @change="handleChange">
                </a-select>
            ...
            <div class="mb-4">
                <global-label for="name" value="Color" :required="false" />
                            ...
                            <div class="rounded-md bg-white shadow-xs px-4 py-3">
                                <div class="flex flex-wrap -mx-2">
                                    <ColorPicker theme="dark" :color="form.color" :sucker-hide="true"
                                        @changeColor="changeColor" @openSucker="openSucker"
        ...
        <div class="flex gap-2">
            ...
            <Link preserve-scroll :href="route('subjects.index')" class="hover:text-gray-500">
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.form.post(this.route("subjects.update", this.subject.id), {
                    onSuccess: (page) => {

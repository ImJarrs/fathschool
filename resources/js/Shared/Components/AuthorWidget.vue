<template>
    <div>
        <div class="help-icon">
            <svg class="question" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            ...
            <div class="help-menu-wrapper">
                <div class="help-menu">
                    <ul>
                        <li> <a href="https://templatecookie.com/get-support"> {{ __('help_and_support') }} </a> </li>
                        <li> <a href="https://templatecookie.com/docs"> {{ __('documentation') }} </a> </li>
                        <li> <a
                                href="https://roadmap.templatecookie.com/">
                                {{ __('product_roadmap') }} </a> </li>
                        <li> <a href="https://codecanyon.net/downloads"> {{ __('give_feedback') }} </a> </li>
                    </ul>
                    <hr>
                    <ul>
                        <li><a href="https://templatecookie.com/">{{ __('about_us') }}</a></li>
                        <li><a href="https://templatecookie.com/hire-us" target='_blank' >{{ __('hire_us') }}</a></li>
                    </ul>
                    <hr>
                    <ul>
                        <li><a href="https://codecanyon.net/user/templatecookie">{{ __('developed_by_templatecookie') }}</a>
                        </li>
                    </ul>
                </div>
            </div>

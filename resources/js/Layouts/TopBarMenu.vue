    ...
    <div class="hs-dropdown relative inline-flex" data-hs-dropdown-placement="bottom-right">
        ...
        >
            <img
                ...
                :src="$page.props.auth && $page.props.auth.profile_photo_url ? $page.props.auth.profile_photo_url : '/assets/backend/images/default-avatar.png'"
                :alt="$page.props.auth ? $page.props.auth.name : ''"
            />
        </button>

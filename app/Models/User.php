...
class User extends Authenticatable
{
    ...
    public function getProfilePhotoUrlAttribute()
    {
        ...
        // Check if it's a storage-based path (no slash at start, likely from uploadImageStorage)
        if (strpos($this->profile_photo_path, '/') === 0) {
            // Legacy public/uploads path - use asset directly
            return asset($this->profile_photo_path);
        } else {
            // Storage disk path - use Storage helper to generate URL with /storage prefix

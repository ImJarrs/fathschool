...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        Setting::create([
            'app_name' => 'FathSchool',
            'text_logo_name' => 'FathSchool',
            'app_email' => 'FathSchool@mail.com',
            'principal_name' => 'FathSchool Principal',
            ...
            'app_description' => 'FathSchool is a constituent institution of the University of Dhaka.  Main goal  is to establish an institution of high academic standard for higher studies and research in economics and related disciplines. Different Economic based BSc, MSc & Diploma degrees are available here.,',
